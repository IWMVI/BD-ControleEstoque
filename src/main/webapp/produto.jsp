...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container text-center my-4">
        <form action="produto" method="post">
            ...
            <div class="form-group">
                ...
                <input class="btn btn-light" type="submit" name="enviar" value="Calcular Valor Médio" />
                <input class="btn btn-dark" type="submit" name="enviar" value="Listar Produtos sem Estoque" />
            </div>
        </form>
    </div>
    ...
    <c:if test="${not empty valorMedio}">
        <div class="container text-center">
            <h2>Valor Médio dos Produtos: ${valorMedio}</h2>
        </div>
    </c:if>
